        ...
        <div class="offset-lg-3 col-lg-6">
          <div class="card miBorder">
            ...
            <div class="card-block">
              <form class="" action="/photoperfil" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                  <a href="{{url('/gastronomica/usuarios/usuario')}}" class="btn btn-outline-secondary">Cancelar</a>
