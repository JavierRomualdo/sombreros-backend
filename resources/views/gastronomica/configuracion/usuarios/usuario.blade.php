...
@section('content')
  ...
  <section class="forms">
    <div class="container-fluid">
      ...
      <a href="{{url('/gastronomica/configuracion/usuarios/usuario/create')}}" class="btn btn-primary margenInf">Nuevo</a> &nbsp;
      <div class="row">
                ...
                <tbody>
                  @foreach ($usuario as $usuarios)
                    <tr>
                      ...
                      <td>
                        <a href="{{action('Usuarios\UsuarioController@foto',$usuarios->id)}}">
