        ...
        <div class="offset-lg-3 col-lg-6">
          <div class="card miBorder">
            ...
            <div class="card-block">
              <form class="" action="/photousuario" enctype="multipart/form-data" method="post">
                <div class="form-group">
                  ...
                  <label for="" class="form-control text-center">
                    <img src="/images/usuarios/{{$usuario->photo}}" name="foto" id="mifoto" class="rounded" width="150" height="150" alt="">
                  </label>
                </div>
                <div class="form-group">
                  <a href="{{url('/gastronomica/configuracion/usuarios/usuario')}}" class="btn btn-outline-secondary">Cancelar</a>
                  <input type="submit" name="grabar" value="Guardar" class="btn btn-outline-primary">
                </div>
              </form>
            </div>
          </div>
