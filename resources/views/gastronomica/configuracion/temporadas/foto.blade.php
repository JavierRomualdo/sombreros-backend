        ...
        <div class="offset-lg-3 col-lg-6">
          <div class="card miBorder">
            ...
            <div class="card-block">
              <form class="" action="/phototemporada" enctype="multipart/form-data" method="post">
                <div class="form-group">
                  ...
                  <label class="form-control custom-file" id="customFile">
                    ...
                    <input type="hidden" name="id" id="id" value="{{$temporada->id}}">
                  ...
                  <label for="" class="form-control text-center">
                    <img src="/images/temporadas/{{$temporada->photo}}" name="foto" id="mifoto" class="rounded" width="150" height="150" alt="">
                  </label>
                </div>
                <div class="form-group">
                  <a href="{{url('/gastronomica/configuracion/temporadas/temporada')}}" class="btn btn-secondary">Cancelar</a>
