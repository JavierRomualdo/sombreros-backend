...
<style type="text/css"> #divredondo, #estado_orden { height:20px; width:20px; border-radius:10px; } </style>
  <div class="breadcrumb-holder fadeIn animated">
    <div class="container-fluid">
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/gastronomica/sombreros/pedidosreposicion/pedidoreposicion')}}">Pedidos Reposicion</a></li>
  ...
  <section class="forms">
    <div class="container-fluid">
            ...
            <div class="card-block">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-2 col-3">
                  <label class="form-control-label" for="fecha">{!!$pedido->fecha!!}</label>
                </div>
                ...
                <label class="col-sm-2 col-3 form-control-label" for="precio_total"><strong>Total:</strong></label>
                <div class="col-sm-2 col-3">
                  <label class="form-control-label" for="precio_total">S/ {!!$pedido->costoreposicion!!}</label>
                </div>
              </div>
            </div>
          </div>
      ...
      <!--TABLA DETALLE PEDIDO DE REPOSICION-->
      <div class="row">
        <div class="offset-lg-0 col-lg-12">
          <div class="card miBorder fadeIn animated">
            <div class="card-header">
                  ...
                  <tbody>
                    @foreach ($detalles as $index=>$detalle)
                      <tr class="fadeIn animated">
                        ...
                        @if($detalle->stock_actual >= $detalle->stock_minimo)
                            <td>
