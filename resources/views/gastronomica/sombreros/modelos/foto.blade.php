        ...
        <div class="offset-lg-3 col-lg-6">
          <div class="card miBorder">
            ...
            <div class="card-block">
              <form class="" action="/photomodelo" enctype="multipart/form-data" method="post">
                <div class="form-group">
                  ...
                  <label for="" class="form-control text-center">
                    <img src="/images/modelos/{{$modelo->photo}}" name="foto" id="mifoto" class="rounded" width="150" height="150" alt="">
                  </label>
                </div>
                <div class="form-group">
