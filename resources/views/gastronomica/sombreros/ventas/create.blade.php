            ...
            <div class="card-block">
              ...
              <div class="">
                <div class="form-group row">
                  ...
                  <label class="form-control-label col-sm-1"><strong># Doc:</strong></label>
                  <div class="col-sm-3">
                    {!!form::text('numero_documento', null,['id'=>'numero_documento','name'=>'numero_documento','class'=>'form-control',
                    'maxlength'=>'15', 'placeholder'=>'Aqui el numero de boleta o factura'])!!}
                  </div>
                </div>
                <!--<div class="col-sm-12">
                  <hr/>
    ...
    <div id="myModalFotos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal" id="aceptarImagen">Aceptar</button>
            </div>
          </div>
        </div>
      </div>
    ...
    $("#guardar").click(function(){
      ...
      if (mensaje=="") {
          ...
          if(tipo==2){
            ...
            $.get('/ajax-guardarventa/2/'+$("#codigo").val()+'/'+$("#numero_documento").val()+'/'+
            ...
            $.get('/ajax-guardarventa/1/'+$("#codigo").val()+'/'+$("#numero_documento").val()+'/'+
            +$("#cantidad").val()+'/'+$("#precio_venta").val()+'/'+porcentaje_descuento+'/'+
            descuento+'/'+$("#precio_total").val()+'/'+$("#usuario").html()+'/'+
            empleado_id+'/'+cliente_id+'/'+descripcion, function(data){
              //success
