...
@section('content')
  ...
  <section class="forms">
    <div class="container-fluid">
      <a href="{{action('Ventas\VentasController@reporte',$venta->id)}}" target="_blank" class="btn btn-outline-primary margenInf ion-document-text fadeIn animated btn-sm"> Reporte</a>
