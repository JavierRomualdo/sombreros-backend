...
<link rel="stylesheet" href="{{asset('bootstrap4/css/datatables/dataTables.bootstrap4.min.css')}}">
  ...
  <section class="forms">
    <div class="container-fluid">
      ...
      <a href="{{url('/gastronomica/sombreros/ventas/ventas/create')}}" class="btn btn-primary margenInf fadeIn animated btn-sm" title="nueva venta"><i class="ion-plus-round"></i> Nuevo</a> &nbsp;
      <div class="row">
