        ...
        <div class="col-lg-12"><!--offset-lg-3 col-lg-6-->
          <div class="card miBorder fadeIn animated">
            ...
            <div class="card-block">
              ...
              {!!Form::model($cliente, ['action'=>['Clientes\ClienteController@update',$cliente->id],'method'=>'PUT'])!!}
              <div class="form-group row">
                <label class="col-sm-2 form-control-label" for="nombres"><strong>Nombres (*):</strong></label>
                <div class="col-sm-10">
                  {!!form::text('nombres', null,['id'=>'nombres','class'=>'form-control','placeholder'=>'Ingrese nombres compleatos', 'autofocus'])!!}
                </div>
              </div>
              <div class="form-group row">
