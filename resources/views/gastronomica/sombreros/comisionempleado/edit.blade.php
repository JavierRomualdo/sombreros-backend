...
@section('content')
  ...
  <section class="forms">
    <div class="container-fluid">
    {!!Form::model($comision, ['action'=>['Empleados\EmpleadoComisionController@update',$comision->id],'method'=>'PUT'])!!}
      <!--Panel superior-->
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card miBorder fadeIn animated">
            ...
            <div class="card-block">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  {!!form::text('nombres', $empleado->nombres,['id'=>'nombres','name'=>'nombres','class'=>'form-control', 'list'=>'nombresEmpleados'])!!}
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  {!!form::text('precio_venta', $sombrero->precio_venta,['id'=>'precio_venta','class'=>'form-control','placeholder'=>'Aqui precio venta','readonly'=>'true'])!!}
                </div>
                <label class="col-sm-2 form-control-label" for="comision"><strong>Comision:</strong></label>
                <div class="col-sm-4">
                  {!!form::text('comision', $sombrero->precio_venta*($comision->porcentaje/100.00),['id'=>'comision','class'=>'form-control','placeholder'=>'Aqui la comision','readonly'=>'true'])!!}
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 form-control-label" for="descripcion"><strong>Descripcion:</strong></label>
                <div class="col-sm-4">
                  {!!form::textarea('descripcion',$comision->descripcion,['id'=>'descripcion','class'=>'form-control','placeholder'=>'Digite la Descripcion',
                    'rows'=>"3", 'cols'=>"8"])!!}
                </div>
                  <div class="col-sm-6">
                    <a href="{{url('/gastronomica/sombreros/comisionempleado/comision')}}" class="btn btn-outline-primary ion-android-cancel"> Cancelar</a>
