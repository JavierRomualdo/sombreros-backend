  ...
  <div class="breadcrumb-holder fadeIn animated">
    <div class="container-fluid">
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item active fadeIn animated"> Eliminar</li>
      </ul>
    </div>
  </div>
  <section class="forms">
        ...
        <div class="offset-lg-3 col-lg-6">
          ...
          <div class="card miBorder fadeIn animated">
            <div class="card-header d-flex align-items-center">
              <h2 class="h5 display fadeIn animated ion-paperclip"><strong style="color:#f00"> Eliminar:</strong></h2>
            </div>
