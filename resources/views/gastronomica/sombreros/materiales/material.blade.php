...
@section('content')
  ...
  <section class="forms">
    <div class="container-fluid">
      <header>
        <h1 class="h5 fadeIn animated text-center ion-clipboard"> Lista Materiales</h1>
      </header>
      @include('partials.messages')
      <a href="{{url('/gastronomica/sombreros/materiales/material/create')}}" class="btn btn-outline-primary btn-sm margenInf fadeIn animated ion-plus-round" title="nuevo material"> Nuevo</a> &nbsp;
      <div class="row">
        <div class="col-lg-12">
