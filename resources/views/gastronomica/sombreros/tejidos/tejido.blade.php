...
<link rel="stylesheet" href="{{asset('bootstrap4/css/datatables/dataTables.bootstrap4.min.css')}}">
  ...
  <section class="forms">
    <div class="container-fluid">
      <header>
        <h1 class="h2 fadeIn animated text-center ion-clipboard"> Lista: Calidad Tejido</h1>
      </header>
      @include('partials.messages')
      <a href="{{url('/gastronomica/sombreros/tejidos/tejido/create')}}" class="btn btn-primary margenInf fadeIn animated ion-plus-round btn-sm"> Nuevo</a> &nbsp;
