        ...
        <div class="col-lg-12">
          <div class="card miBorder fadeIn animated">
            <div class="card-header d-flex align-items-center">
              <h2 class="h6 display ion-paperclip fadeIn animated"> Cliente:</h2>
            </div>
            <div class="card-block">
              <div class="form-group row">
                <label class="col-sm-1 form-control-label text-center"><strong>Cliente:</strong></label><!--offset-sm-1 -->
                <div class="col-sm-4">
                  <div class="input-group">
                    <input type="text" id="cliente" class="form-control" readonly=""/>
                    <button type="button" name="edit" id="edit" class="btn btn-primary fa fa-edit rounded" title="buscar cliente"></button>
                  </div>
                </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="h5 modal-title ion-paperclip" id="exampleModalLabel"> Clientes</h5>
  ...
  <div id="modalFoto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    ...
    $(document).ready(function(e){
     ...
     var cliente_id;
      ...
      function mostrarCliente(idCliente, nombre){
        $("#cliente").val(nombre);
      ...
      $("#buscar").click(function(e){
        var mensaje = "";
        if($("#cliente").val()==""){
          mensaje = mensaje + "* El cliente no debe estar vacia.<br/>";
        }
        if ($("#fecha_inicio").val()=="") {
    ...
    function cargarVentas(){
      if($("#cliente").val()!=""){
        ...
        $.get('/ajax-ventasClienteConsolidado/'+cliente_id+'/'+$("#fecha_inicio").val()+'/'+
        $("#fecha_fin").val(), function(dato){
          ...
          $.each(dato, function(index, venta){
            ...
            venta.precio_total+"</td><td>"+venta.nombres+"</td><td>"+
